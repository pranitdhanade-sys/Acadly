# Building a Compiler Frontend with AST Passes
...
Building building a compiler frontend with ast passes well requires balancing simplicity and long-term operability.
