# Building a Stream Processor with Exactly-Once Semantics
...
Building building a stream processor with exactly-once semantics well requires balancing simplicity and long-term operability.
